...
internal let LsqCyclePictureCellIdentifier: String = "LsqCyclePictureViewCell"
...
public class LsqCyclePictureView: UIView {
    
    //pictures item 如果名称带 http 则默认加载网络图片，其他加载本地图片
    ...
    internal lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(JCyclePictureViewCell.self, forCellWithReuseIdentifier: LsqCyclePictureCellIdentifier)
...
extension LsqCyclePictureView: UIScrollViewDelegate {
...
extension LsqCyclePictureView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let customCellHandle = self.customCellHandle {
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: LsqCyclePictureCellIdentifier, for: indexPath) as! JCyclePictureViewCell
            ...
            if self.datas![indexPath.item].hasPrefix("http") {
                cell.imageView.sd_setImage(with: URL(string: self.datas![indexPath.item]), placeholderImage: self.placeholderImage)
            } else {
